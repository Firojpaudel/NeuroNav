...
def process_command(action):
    """Simulate wheelchair movement based on the action."""
...
title_label = tk.Label(window, text="Wheelchair Movement Simulator", font=("Helvetica", 16))
...
wheelchair_img = Image.open("wheelchair.png")  # Replace with the path to your wheelchair image
